...
public class HouseServiceImpl implements HouseService {
	 ...
	 * @return 아파트 식별 번호에 해당하는 아파트 거래 정보를 찾아서 리턴한다, 없으면 null이 리턴됨 ------->>이거 뭔말,,,,
	 */
	@Override
	public HouseDeal search(int no) {

		// complete code #03
		// no를 받으면 HouseDeal을 return한다.
		// null 을 return 하면 안됩니다. Dao Layer 의 적절한 method를 호출하여 Business Logic 을 완성하세요.
		HouseDeal houseDeal = new HouseDeal();
		houseDeal = dao.search(no);

		if (houseDeal != null)
			return houseDeal;
		// 따로 나중에..
		else {
			System.out.println("search null값 에러 주의.......");
			return null;
		}
//            //////////////null 처리 하라는건지..? Exception 처리할까../////////////////
	}
}
